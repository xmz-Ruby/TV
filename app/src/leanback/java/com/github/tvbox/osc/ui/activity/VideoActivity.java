...
import com.github.tvbox.osc.bean.Part;
...
import com.github.tvbox.osc.ui.presenter.EpisodePresenter;
import com.github.tvbox.osc.ui.presenter.FlagPresenter;
import com.github.tvbox.osc.ui.presenter.ParsePresenter;
import com.github.tvbox.osc.ui.presenter.PartPresenter;
import com.github.tvbox.osc.ui.presenter.QuickPresenter;
...
public class VideoActivity extends BaseActivity implements CustomKeyDownVod.Listener, TrackDialog.Listener, TrackDialog.ChooserListener, PlayerDialog.Listener, ArrayPresenter.OnClickListener, Clock.Callback, com.github.tvbox.osc.impl.DanmuSettingCallback, com.github.tvbox.osc.ui.dialog.QualityDialog.Listener {
    ...
    private void updateHistory(Episode item, boolean replay) {
        ...
        long targetPosition = (mPendingResumePosition > 0) ? mPendingResumePosition : (replay ? 0 : mHistory.getPosition());
