...
public class DLNADevice {
    ...
    public List<com.github.tvbox.osc.bean.Device> getAll() {
        List<com.github.tvbox.osc.bean.Device> items = new ArrayList<>();
        for (org.fourthline.cling.model.meta.Device<?, ?, ?> item : devices) items.add(create(item));
        return items;
    }

    public List<com.github.tvbox.osc.bean.Device> add(org.fourthline.cling.model.meta.Device<?, ?, ?> item) {
        devices.remove(item);
        devices.add(item);
        return getAll();
    }
