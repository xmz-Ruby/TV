...
import com.github.tvbox.osc.databinding.ActivityLiveBinding;
...
import com.github.tvbox.osc.ui.adapter.ChannelAdapter;
import com.github.tvbox.osc.ui.adapter.EpgDataAdapter;
import com.github.tvbox.osc.ui.adapter.GroupAdapter;
import com.github.tvbox.osc.ui.base.BaseActivity;
import com.github.tvbox.osc.ui.custom.CustomKeyDownLive;
...
public class LiveActivity extends BaseActivity implements Clock.Callback, CustomKeyDownLive.Listener, TrackDialog.Listener, PlayerDialog.Listener, Biometric.Callback, PassCallback, LiveCallback, GroupAdapter.OnClickListener, ChannelAdapter.OnClickListener, EpgDataAdapter.OnClickListener, CastDialog.Listener, InfoDialog.Listener {
    ...
    private void onCast() {
        CastDialog.create().video(CastVideo.get(mBinding.control.title.getText().toString(), mPlayers.getUrl(), mPlayers.getPosition(), mPlayers.getDuration(), mPlayers.getHeaders(), mPlayers.getFormat())).live(true).fm(false).show(this);
    }
    ...
    private void scheduleLiveUpdate() {
        App.post(mR4, LIVE_UPDATE_INTERVAL_MS);
    }
    ...
    private void updateLineStatus() {
        ...
        mBinding.control.action.line.setText(text);
        mBinding.widget.line.setVisibility(mChannel.getLineVisible());
    ...
    private void mergeLiveUpdate(Live update) {
        ...
        for (Group sourceGroup : update.getGroups()) {
            ...
            if (targetGroup == null) {
                ...
                else mGroupAdapter.add(targetGroup);
            }
    ...
    private void checkNext() {
        ...
        if (hasNext) onItemClick(mChannel.getData().getList().get(position));
            ...
            // 对于直播，播放结束时尝试下一个线路，禁止自动换频道
            android.util.Log.d("LiveActivity", "直播播放结束，尝试下一个线路（禁止换频道）");
            startFlow();
        }
    }
