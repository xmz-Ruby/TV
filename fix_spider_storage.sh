...
# 用法: ~/yorkspace/github/TV/fix_spider_storage.sh ~/yorkspace/apktool_2.12.1.jar ~/yorkspace/单线路1120/TVBoxOSC/tvbox/spider.jar  ~/yorkspace/单线路1120/TVBoxOSC/tvbox/custom_spider_modified.jar
